function calculateLove() {
    ...
    if (name1 === "SARAVANAN" && name2 === "NEDUMADURAI") {
        ...
        fetch('https://lovecalculator.onrender.com/submit_names', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            const url = `https://lovecalculator.onrender.com/result.html?name1=${encodeURIComponent(name1)}&name2=${encodeURIComponent(name2)}&loveScore=${loveScore}&quote=${encodeURIComponent(randomQuote)}`;
